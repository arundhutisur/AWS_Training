...
public interface AccountService {
	...
	Account depositAmount(String accountNumber, Account account) throws AccountNotFoundException;
	
	Account withdrawAmount(String accountNumber, Account account) throws Exception;
}